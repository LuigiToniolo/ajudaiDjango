...
from ajudai_django_app.models import ChatBot, Conversa, CustomUser, DadosClienteCadatrado, Pedido, Product, Adesao_Purchase, Premium_User_Payment_Method_Registration
