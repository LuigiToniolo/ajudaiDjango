...
IS_DEVELOPMENT_ENV = str(os.environ.get("ENV")).lower() == "development"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "ajudai_django_app.context_processors.notifications_list",
            ],
        },
    },
]
...
if USE_MYSQL:
    DATABASES = {
        "default": {
            ...
            "HOST": env("MYSQL_DB_HOST", default="localhost"),
...
AUTH_USER_MODEL = "ajudai_django_app.CustomUser"
